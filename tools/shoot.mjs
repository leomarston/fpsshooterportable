...
try {
  ...
  await page.evaluate(() => { const g = window.__game; g.input.locked = true; g.input.enabled = true; g.startGame(); g.closeBuy(); g.frozen = false; g._freezeEnd = 0; g.input.buttons.left = false; });
